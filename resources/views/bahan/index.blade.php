...
@section('container')
    ...
    <div class="card-header pb-0 p-3">
        ...
        <div class="col-6 text-end">
            <a class="btn bg-gradient-dark mb-3" href="/bahan/create"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Tambah Data</a>
        </div>
        </div>
    </div>
    ...
    <table class="table align-items-center mb-0">
        ...
        <tr>
            ...
            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Stok Bahan</th>
        ...
        <tr>
            ...
            <span class="text-secondary text-xs font-weight-bold">{{ $item->satuan }}</span>
            </td>
            <td class="align-middle">
            <form action="{{asset('/bahan/'.$item->id.'/edit')}}" method="POST">
                @csrf
                @method('get')
