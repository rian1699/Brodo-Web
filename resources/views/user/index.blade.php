...
@section('container')
    ...
    <div class="card-header pb-0 p-3">
        ...
        <div class="col-6 text-end">
            <a class="btn bg-gradient-dark mb-3" href="/user/create"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Tambah Data</a>
        </div>
        </div>
    </div>
    ...
    <table class="table align-items-center mb-0">
        ...
        <tr>
            ...
            <div class="d-flex px-2 py-1">
                ...
                <h6 class="mb-0 ms-2 text-sm">{{ $item->nama_dpn }}</h6>
                </div>
            </div>
            </td>
            <td>
            <div class="d-flex px-2 py-1">
                <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 ms-2 text-sm">{{ $item->nama_blkng }}</h6>
                </div>
            </div>
            </td>
            ...
            <form action="{{asset('/user/'.$item->id.'/edit')}}" method="POST">
                @csrf
                @method('get')
