      ...
      <div class="card-body">
        <form  action="/produk/{{ $produks->id }}" method="post">
          ...
          <div class="input-group input-group-outline mb-3">
            ...
            <input type="text" class="form-control" name="nama" id="nama" value="{{old('nama', $produks->nama)}}" required placeholder="Nama Produk">
          </div>
          <div class="input-group input-group-outline mb-3">
            <label class="form-label"></label>
            <input type="number" class="form-control" name="stok" id="stok" value="{{old('stok', $produks->stok)}}" required placeholder="Stok Produk">
          </div>
